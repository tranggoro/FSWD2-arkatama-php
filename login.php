              ...
              <div class="mb-md-5 mt-md-4 pb-5">
                ...
                <form action="" method="post">
                  <div class="form-outline form-white mb-4">
                    ...
                    <input type="email" name="email" id="typeEmailX" placeholder="Masukkan email terdaftar"
                      autocomplete="off" class="form-control form-control-lg" />
                  </div>

                  <div class="form-outline form-white mb-4">
                    <label class="form-label" for="typePasswordX">Password</label>
                    <input type="password" name="password" id="typePasswordX" placeholder="Masukkan password"
