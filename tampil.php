            ...
            <table class="table table-bordered" style="margin-top: 30px;">
                ...
                while ($data = mysqli_fetch_array($query)) {
                    ...
                    <tr>
                        ...
                        <td><a href="hapuscrud.php?id=<?php echo $data['id'] ?>"
                                onclick="return confirm('Apakah anda ingin menghapus data ini?')"
                                class="btn btn-danger btn-sm btn-block">Hapus</a></td>
                        <td align='center'><img src="gambar/<?php echo $data['avatar'] ?>" height="50" width="50" alt="...">
                        </td>
                        <td>
                            <?php echo $data['name'] ?>
                        </td>
